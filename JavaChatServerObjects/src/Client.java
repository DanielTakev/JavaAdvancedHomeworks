...
public class Client {
    ...
    void send(String s){
        if(s.length()==0){
            ...
            Messages message = new Messages(s, name, clientInetAddress);
            try {
